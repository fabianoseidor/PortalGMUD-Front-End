													...
													<div class="card-block">
			                                            <div class="form-row">
															...
															<div class="form-group form-default form-static-label col-md-6 mb-6">
															     ...
															     <input style="color: #000000" type="text" name="categoriaPadrao" id="categoriaPadrao" class="form-control" placeholder="Categoria Padrão" value="">
															</div>
														...
														<div class="form-row">
															<div class="form-group form-default form-static-label col-md-12 mb-12">
															     ...
															     <textarea style="color: #000000" class="form-control" id="Obs" name="Obs" placeholder="Observação" rows="100" ></textarea>
															</div>
														</div>
										                ...
										                <div class="card">
														 ...
														 <div class="card">
										                    <h5 class="card-header border-primary">Lista de Categoria Padrão Cadastradas</h5>
			 												<!-- Tabela com as informacoes do Recursos a serem cadastrasdos -->                       
															<div class="row">
																<div class="col-sm-12">
																	<!-- Basic Form Inputs card start -->
