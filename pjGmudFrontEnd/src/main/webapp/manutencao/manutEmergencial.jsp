...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
				           ...
				           <div class="row align-items-center">
				               <div class="col-md-10">
				                   <div class="page-header-title">
				                       ...
				                       <p class="m-b-0"></p>
				                       <a class="btn btn-primary float-right" href="<%= request.getContextPath() %>/principal/telaPrincipal.jsp" style="border-radius: 25px;" role="button" style="color: white;">Voltar</a>
				                   </div>
				               </div>
                           ...
                           <div class="page-body">
                              <div class="row">
                                 <div class="col-sm-12">
                                    ...
                                    <form class="form-material" action="" method="get" id="formCadMudancaEmergencia">
	...
	<div class="modal-dialog modal-dialog-centered .modal-sm"  style="max-width: 50% !important;" role="document">
		<div class="modal-content">
						...
						<div class="card">
							<div class="card-block">	
								<div class="form-row">
			                       ...
			                       <textarea style="color: #000000" class="form-control" id="planoRetornoFechamento" disabled="disabled" name="planoRetornoFechamento" rows="10" ></textarea>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer">
				<button type="button" id="btModalFechaGMUD" class="btn btn-outline-success" onclick="fecharTarefa( );">Fechar GMUD</button>
  ...
  function getGMUDPassadaParamentro() {
	 ...
	 let urlAPI  = urlBase + 'pesquisaMudancaEmergencial/';

	 idMudancaPar = document.getElementById( 'idMudancaParametro').value; 
//	 urlApi = "http://localhost:8090/PortalMudanca/pesquisaMudancaEmergencial/" + idMudancaPar.trim();
...
//			url        : "http://localhost:8090/PortalMudanca/obterPorIdAtividadeMudanca/"+ idTarefa                            ,
			...
			hideLoading();
			MensagemConfimacao( "error", "Tarefa", "Erro ao Obter Atividade GMUD Por Id: " + xhr.responseText) ;
		});		 
  }
...
//     alert( 'id: ' + idSelect + ' - idResponsavel: ' + idResponsavel + ' - idAtividadeMudanca: ' + idAtividadeMudanca );
	 ...
	 async function ExecutaFechamentoGMUD(url) {
	     try {
	        ...
	        if( validacao !== 'OK'  ) throw validacao;  
	         ...
	         if( data1 > 0  ) throw 'Todas as Tarefas devem ser encerradas antes do fechamento da GMUD.';
...
//	         console.log( data2 );
	         ...
	         if( data2 === 'sucesso' ){
	        	 ...
	        	 // MensagemConfimacaoModal( "success", "Fechamento de GMUD",  "GMUD Fechada com Sucesso!", "modalFinalizarGMUD" );	
	             // getGMUDPassadaParamentro();
