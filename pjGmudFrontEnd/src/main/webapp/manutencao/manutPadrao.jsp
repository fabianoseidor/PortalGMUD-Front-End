                           ...
                           <div class="page-body">
                              <div class="row">
                                 <div class="col-sm-12">
                                    ...
                                    <form class="form-material" action="" method="get" id="formCadMudancaPadrao">
													...
													<div class="card-block">
														...
														<div class="form-row">
															...
															<div class="form-group form-default form-static-label col-md-4 mb-4">
																...
																<input style="color: #000000" type="text" name="categoriaPadrao" id="categoriaPadrao" class="form-control" disabled="disabled">
															</div>
...
<!-- 
 ...
 -->			  
  ...
  function getGMUDPassadaParamentro() {
	 ...
	 let urlAPI  = urlBase + 'pesquisaMudancaPadrao/';
	 
	 idMudancaPar = document.getElementById( 'idMudancaParametro').value; 
//	 urlApi = "http://localhost:8090/PortalMudanca/pesquisaMudancaPadrao/" + idMudancaPar.trim();
...
//    console.log( "statusMudanca: " + mudanca.statusMudanca );
  ...
  function getGMUDTituloPorId(urlAPI){
		...
		$.ajax({
			...
			// alert("Erro ao Listar Mudanças: " + xhr.responseText);
			hideLoading();
			MensagemConfimacao( "error", "GMUD", "Erro ao Obter Atividade GMUD por Título: " + xhr.responseText) ; 
		});		
  }
...
//	   	     let reportFinal  = document.getElementById( 'reportFinalFechamento' ).value;
	   	     ...
	   	     let urlAPI       = urlBase + 'updadeStatuFechamentoPadraoMudancaDTO';
