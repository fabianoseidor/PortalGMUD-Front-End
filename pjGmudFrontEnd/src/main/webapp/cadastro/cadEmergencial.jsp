				           ...
				           <div class="row align-items-center">
				               <div class="col-md-12">				               
				                   <div class="page-header-title">
									   <div class="row">
										  <div class="col-lg-10">
										  	<h5 class="m-b-1">Portal de GMUD - Cadastro de Mudança Emergencial</h5>
										  </div>
                           ...
                           <div class="page-body">
                              <div class="row">
                                 <div class="col-sm-12">
								    ...
								    <h3 class="text-muted">Cadastro de Mudança Emergencial - Passo <samp id="passo"></samp></h3>
								    <br>
                                            ...
                                            <div id="step_2" class="step">
                                                 ...
                                                 <div class="row">
												    <div class="col-sm-12">
												        <div class="card">
														    <div class="card-block">
														        <h5 class="card-title">Sessão para seleção dos 'Aprovadores' da GMUD</h5><hr>
				                                                <div class="form-row">
												...
												<div class="row">
                                                 ...
                                                 <div class="row">
													<div class="col-sm-12">
														<div class="card">
															<div class="card-block">
															    <h5 class="card-title">Sessão para seleção dos 'Arquivos de Aprovação' do(s) Cliene(s)</h5><hr>
															    <div class="form-row">
															         <div class="form-group form-default form-static-label col-md-12 mb-12">
															    ...
															    <div class="form-row">
																	<div class="form-group form-default form-static-label col-md-5">
																	     <label  class="font-weight-bold font-italic" style="color: #708090" >Título Arq. Aprovação Cliente</label>
																	     <input style="color: #000000" type="text" name="tituloArqAprovCliente" id="tituloArqAprovCliente" class="form-control">
																	</div>
				                                                </div>
				                                                <div class="form-row">
																	<div class="form-group form-default form-static-label col-md-5">
																	     <label  class="font-weight-bold font-italic" style="color: #708090" >Nome Arq. Aprovação Cliente</label>
																	     <input style="color: #000000" type="text" name="nomeArqAprovCliente" id="nomeArqAprovCliente" class="form-control" readonly="readonly">
																	</div>
				 													<div class="form-group form-default form-static-label col-md-5" >
																	    <label class="font-weight-bold font-italic" id="lbperiodoUtilizacaoMAR" >Arquivo Aprovação Cliente</label>
																	...
																	<div class="form-group form-default form-static-label col-md-2" >
																	    <label class="font-weight-bold font-italic" id="lbperiodoUtilizacaoMAR" >Extensão Arq.</label>
													...
													<div class="col-sm-12">
														<div class="card">
															<div class="card-block">
																...
																<hr>  
																<br>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px; margin-right: 15px;" name="btAddClientesAfetado" id="btAddClientesAfetado" onclick="mudancaEmergencial.salvarClientesAfetado();">Add</button>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px; margin-right: 15px;" name="btLimparAddClientesAfetado" id="btLimparAddClientesAfetado" onclick="mudancaEmergencial.limparListaClientesAfetados();">Limpar Lista</button>
											                </div>
													    </div>
											        </div>
											     </div>
										  ...
										  <div class="card-block">
											  <div class="row">
												  ...
												  <div id="divBtSalvar" class="col-lg-6" style="display:none">
												  	<button type="button" class="btn btn-block btn-outline-success" name="btSalvarGMUDNormal" id="btSalvarGMUDNormal" data-toggle="tooltip" data-placement="top" title="Salvar nova Mudança" onclick="desabilitaBotaoSalvar();mudancaEmergencial.salvarGMUDEmergencial();">Salvar Mudança</button>
												  </div>
