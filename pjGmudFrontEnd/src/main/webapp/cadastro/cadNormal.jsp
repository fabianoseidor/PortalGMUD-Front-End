													...
													<div class="col-sm-12">
														<div class="card">
															<div class="card-block">
																...
																<hr>  
																<br>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px;" name="btAddClientesAfetado" id="btAddClientesAfetado" onclick="mudancaNormal.salvarClientesAfetado();">Add</button>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px;" name="btLimparAddClientesAfetado" id="btLimparAddClientesAfetado" onclick="mudancaNormal.limparListaClientesAfetados();">Limpar Lista</button>
											                </div>
													    </div>
											        </div>
											     </div>
