...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                           ...
                           <div class="page-body">
                              <div class="row">
                                 <div class="col-sm-12">
								    ...
								    <h3 class="text-muted">Cadastro de Mudança Normal - Passo <samp id="passo"></samp></h3>
								    <br>
                                    <form class="form-material formCadMudancaNormalValidacao" action="" method="post" id="formCadMudancaNormal" enctype="multipart/form-data">
                                            <!-- ##################################################################################### -->
															...
															<div class="card-block">
					                                            <div class="form-row">
																	...
																	<div class="form-group form-default form-static-label col-md-2 mb-6">
																	     ...
																	     <input style="color: #000000" type="text" name="tipoMudanca" id="tipoMudanca" readonly="readonly" class="form-control" value="Normal">
																	</div>
												    ...
												    <div class="col-sm-12">
												        <div class="card">
														    <div class="card-block">
																...
																<hr>  
																<br>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px;" name="btAddAprovadores" id="btAddAprovadores" onclick="mudancaNormal.salvarAprovadores();">Add</button>
															</div>
														</div>
													</div>
												 </div>
													...
													<div class="col-sm-12">
														<div class="card">
															<div class="card-block">
																...
																<hr>  
																<br>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px; margin-right: 15px;" name="btAddClientesAfetado" id="btAddClientesAfetado" onclick="mudancaNormal.salvarClientesAfetado();">Add</button>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px; margin-right: 15px;" name="btLimparAddClientesAfetado" id="btLimparAddClientesAfetado" onclick="mudancaNormal.limparListaClientesAfetados();">Limpar Lista</button>
											                </div>
													    </div>
											        </div>
											     </div>
												...
												<br>
                                                 ...
                                                 <div class="row">
													<div class="col-sm-12">
														<div class="card">
															<div class="card-block">
															    <h5 class="card-title">Sessão para seleção dos Contatos para o 'Plano de Comunicação'</h5><hr>
																<div class="form-row">
																...
																<hr>  
																<br>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px;" name="btAddPlanoComunicacao" id="btAddPlanoComunicacao" onclick="mudancaNormal.salvarPlanoComunicacao();">Add</button>
											                </div>
													    </div>
											        </div>
											     </div>
															...
															<div class="card-block">
				                                                ...
				                                                <div class="form-row" style="display: flex; align-items: center;">
																    ...
																    <div class="form-group form-default form-static-label col-md-2 mb-4">
																	    <div class="form-check form-check-inline">
																		  ...
																		  <label class="form-check-label" for="inlineCheckbox2">Tarefa automático</label>
																		</div>
																    </div>
				                                                ...
				                                                <div class="form-row">
																	...
																	<div class="form-group form-default form-static-label col-md-2" >
																	    ...
																	    <input style="color: #000000" type="time" name="duracaoTarefa" id="duracaoTarefa" ng-value="start_date | date : 'HH:mm'" class="form-control" onchange="validacaoDataHoraTarefaJanelaGMUD();" onclick="iniciarTimeDuracao()">								     
																	</div>	
				                                                </div>
				                                                ...
				                                                <div class="from-row">
																	<div class="form-group form-default form-static-label col-md-12 mb-12">
																	     ...
																	     <textarea style="color: #000000" class="form-control" id="descricaoTarefa" name="descricaoTarefa" placeholder="Observação" rows="100" ></textarea>
																	</div>
				                                                </div>
																<hr>  
																<br>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px;" name="btAddTarefa" id="btAddTarefa" onclick="mudancaNormal.salvarTarefa();">Add</button>
											                </div>
													    </div>
											        </div>
											     </div>
																	...
																	<table class="table table-striped table-hover table-sm table-bordered table-responsive-sm" id="tabelaTarefas">
																		  <thead>
																		    <tr class="table-primary">
																		      ...
																		      <th scope="col" style="text-align: center; vertical-align: middle;color: white">Tarefa Automática </th>
													...
													<div class="col-sm-12">
														<div class="card">
															<div class="card-block">
																...
																<hr>  
																<br>
																<button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" style="border-radius: 25px;" name="btAddProduto" id="btAddProduto" onclick="mudancaNormal.salvarArquivo();">Add</button>
											                </div>
													    </div>
											        </div>
											     </div>
                                            ...
                                            <div id="step_7" class="step">
                                                ...
                                                <button type="button" class="btn waves-effect waves-light btn-outline-success float-right pequeno" name="btSalvarGMUDNormal" id="btSalvarGMUDNormal" onclick="desabilitaBotaoSalvar();mudancaNormal.salvarGMUDNormal();">Salvar</button>
										  ...
										  <div class="card-block">
											  <div class="row">
												  ...
												  <div id="divBtSalvar" class="col-lg-6" style="display:none">
												  	<button type="button" class="btn btn-block btn-outline-success" name="btSalvarGMUDNormal" id="btSalvarGMUDNormal" data-toggle="tooltip" data-placement="top" title="Salvar nova Mudança" onclick="desabilitaBotaoSalvar();mudancaNormal.salvarGMUDNormal();">Salvar Mudança</button>
												  </div>
											  </div>
										  </div>
									  </div>
  ...
  <script type="text/javascript" src="<%= request.getContextPath() %>/js/cadMudancaNormalController.js"></script>
  <script type="text/javascript" src="<%= request.getContextPath() %>/js/cadCadNormalClass.js"></script>
